...
<div style="display: flex; align-items: flex-start; margin-bottom: 30px;">
  ...
  <div>
    ...
    <a href="/files/Internship_certificate_hoval.pdf" target="_blank" style="text-decoration: none; color: blue; border-bottom: none; transition: border-bottom 0.3s ease-in-out; padding-bottom: 0px;" onmouseover="this.style.borderBottom='2px solid black'" onmouseout="this.style.borderBottom='none'">See Credential</a><br>
  </div>
</div>
